...
echo "🔍 averroes Real-time Debugging Guide"
echo "========================================"
echo ""
...
echo ""
echo "adb logcat -c && adb logcat -v time | grep -E \"(AverroesViewModel|AverroesManager|🔍|✅|❌|⚠️|💥|System not initialized|Native library)\" --color=always"
echo ""
...
echo ""
echo "cd /mnt/d/Engineer/web3/rizilab/averroes/android"
...
echo ""
echo "adb shell am start -n com.rizilab.averroes/.MainActivity"
echo ""
...
echo "   → AverroesManager initialization is failing."
...
echo ""
echo "🔵 If you saw no AverroesViewModel messages at all:"
...
echo "adb logcat | grep -E \"(AverroesManager|initialization|failed|System not initialized)\""
echo ""
...
echo ""
echo "adb logcat -d > averroes_debug_$(date +%Y%m%d_%H%M%S).log"
echo ""
